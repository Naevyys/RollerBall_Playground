...
class Trainer(object):
    def __init__(self, name:str, env_exec:str, models_folder:str, model_class:BaseAlgorithm, policy_class:BasePolicy, model_init_params:dict(), worker_id:int=0, no_graphics:bool=True, run_id:int=None) -> None:
        self.name = name
